/**
 * Maps IANA time zone names to the ISO 3166-1 alpha-2 code of the country they
 * belong to, so the user country can be guessed offline when vpn/location is
 * not reachable. Legacy names kept as links by the tz database are included, as
 * a browser may report one of them.
 */
