...
/**
 * Add a logical to the country list used to render the server list: it goes to
 * the group (city, Secure Core, TOR, free or other) of its exit country, and
 * both the country and the group are created on the fly if needed.
 */
